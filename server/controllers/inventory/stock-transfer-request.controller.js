...
const stockTransferRequestController = {
  ...
  getAll: asyncHandler(async (req, res) => {
    ...
    const result = await stockTransferRequestService.getAll({ ...req.query, brand: brandId, branch: branchId });
    res.json(result);
  }),

  getOne: asyncHandler(async (req, res) => {
    const result = await stockTransferRequestService.getById(req.params.id);
    res.json(result);
  }),
  ...
  delete: asyncHandler(async (req, res) => {
    const result = await stockTransferRequestService.delete(req.params.id);
    res.json(result);
  }),

  restore: asyncHandler(async (req, res) => {
    const result = await stockTransferRequestService.restore(req.params.id);
    res.json(result);
  }),
};
