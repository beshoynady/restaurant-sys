...
const inventoryCountController = {
  ...
  getAll: asyncHandler(async (req, res) => {
    ...
    const result = await inventoryCountService.getAll({ ...req.query, brand: brandId, branch: branchId });
    res.json(result);
  }),

  getOne: asyncHandler(async (req, res) => {
    const result = await inventoryCountService.getById(req.params.id);
    res.json(result);
  }),
  ...
  delete: asyncHandler(async (req, res) => {
    const result = await inventoryCountService.delete(req.params.id);
    res.json(result);
  }),

  restore: asyncHandler(async (req, res) => {
    const result = await inventoryCountService.restore(req.params.id);
    res.json(result);
  }),
};

export default inventoryCountController;
