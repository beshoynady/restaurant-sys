...
import { validatePaymentProviderModel } from "../../validation/paymentProvider/payment-provider.validation.js";
...
const paymentProviderController = {
  create: asyncHandler(async (req, res) => {
    ...
    validatePaymentProviderModel(req.body);
  ...
  update: asyncHandler(async (req, res) => {
    ...
    const branchId = req.body.branch ?? req.branch._id;
    const userId = req.user._id;
    validatePaymentProviderModel(req.body, true);
