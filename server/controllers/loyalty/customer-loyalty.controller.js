...
import { validateCustomerLoyaltyModel } from "../../validation/loyalty/customer-loyalty.validation.js";
...
const customerLoyaltyController = {
  create: asyncHandler(async (req, res) => {
    ...
    validateCustomerLoyaltyModel(req.body);
  ...
  update: asyncHandler(async (req, res) => {
    ...
    const branchId = req.body.branch ?? req.branch._id;
    const userId = req.user._id;
    validateCustomerLoyaltyModel(req.body, true);
