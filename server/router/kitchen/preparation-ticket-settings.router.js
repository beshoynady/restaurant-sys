...
router.route("/")
  ...
  .get(authenticateToken, validate(querySchema()), preparationTicketSettingsController.getAll)
;

// GetOne, Update, SoftDelete
router.route("/:id")
  .get(authenticateToken, validate(paramsSchema()), preparationTicketSettingsController.getOne)
  .put(authenticateToken, validate(updatePreparationTicketSettingsSchema), preparationTicketSettingsController.update)
  .delete(authenticateToken, validate(paramsSchema()), preparationTicketSettingsController.delete) // soft delete
;

// Restore soft-deleted item
router.route("/restore/:id")
  .patch(authenticateToken, validate(paramsSchema()), preparationTicketSettingsController.restore)
;
