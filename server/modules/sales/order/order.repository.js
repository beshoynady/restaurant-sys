...
// database access for Order — generic CRUD + constructor options only. `order.service.ts` extends
// this class and adds every business rule (order-number generation, state-machine transitions,
// item cancel/kitchen-recall) on top — none of that belongs here, matching the same split already
// proven on the `accounting/journal-entry` pilot this migration follows.
